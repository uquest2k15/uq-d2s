/**
 * Tax Audit Support Page JavaScript
...
jQuery(document).ready(function($) {
            ...
            if (firstCounter.length) {
                ...
                if (elementTop < scrollTop + windowHeight - 100) {
                    ...
                    counters.each(function() {
                        const counter = $(this);
                        const numberElement = counter.find('.tax-audit-support-stat__number');
    ...
    function initProcessAnimations() {
        const processItems = $('.tax-audit-support-process__item');
        let hasAnimated = false;
    ...
    function initTestimonialCarousel() {
        const swiperContainer = $('.tax-audit-support-carousel');
        
        if (swiperContainer.length && typeof Swiper !== 'undefined') {
            new Swiper('.tax-audit-support-carousel', {
                slidesPerView: 1,
                spaceBetween: 30,
                loop: true,
                autoplay: {
