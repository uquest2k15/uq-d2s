/**
 * Account Outsourcing Page JavaScript
...
jQuery(document).ready(function($) {
            ...
            if (firstCounter.length) {
                ...
                if (elementTop < scrollTop + windowHeight - 100) {
                    ...
                    counters.each(function() {
                        const counter = $(this);
                        const numberElement = counter.find('.account-outsourcing-stat__number');
    ...
    function initProcessAnimations() {
        const processItems = $('.account-outsourcing-process__item');
        let hasAnimated = false;
    ...
    function initTestimonialCarousel() {
        const swiperContainer = $('.account-outsourcing-carousel');
        
        if (swiperContainer.length && typeof Swiper !== 'undefined') {
            new Swiper('.account-outsourcing-carousel', {
                slidesPerView: 1,
                spaceBetween: 30,
                loop: true,
                autoplay: {
